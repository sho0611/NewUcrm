...
use App\Services\SaveAppointmentController;
...
class AppointmentController extends Controller
{
     ...
     */
        ...
        protected $saveAppointmentController;

        public function __construct(SaveAppointmentController $saveAppointmentController)
        {
        ...
        {
            $appointments = $this->saveAppointmentController->createAppointments(
                $request->item_id,
                $request->customer_id,
                $request->staff_id,
